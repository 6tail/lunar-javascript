;(function(root,factory){
  ...
  var Lunar = (function(){
    ...
    var _new = function(year,month,day,hour,minute,second,solar,ly){
      ...
      return {
        ...
        getJie:function(){
          ...
          d = this._p.jieQi[Lunar.JIE_APPEND_SOLAR_FIRST];
          if(d.getYear()==this._p.solar.getYear()&&d.getMonth()==this._p.solar.getMonth()&&d.getDay()==this._p.solar.getDay()){
        ...
        getQi:function(){
          ...
          d = this._p.jieQi[Lunar.QI_APPEND_SOLAR_SECOND];
          if(d.getYear()==this._p.solar.getYear()&&d.getMonth()==this._p.solar.getMonth()&&d.getDay()==this._p.solar.getDay()){
        ...
        getShuJiu:function(){
          var currentCalendar = new Date(this._p.solar.getYear() + '/' + this._p.solar.getMonth() + '/' + this._p.solar.getDay() + ' 0:0:0');
          var start = this._p.jieQi[Lunar.JIE_QI_APPEND];
          var startCalendar = new Date(start.getYear() + '/' + start.getMonth() + '/' + start.getDay() + ' 0:0:0');
          if (currentCalendar < startCalendar) {
            start = this._p.jieQi[Lunar.JIE_QI_FIRST];
            startCalendar = new Date(start.getYear() + '/' + start.getMonth() + '/' + start.getDay() + ' 0:0:0');
          }
          var endCalendar = new Date(start.getYear() + '/' + start.getMonth() + '/' + start.getDay() + ' 0:0:0');
        ...
        getFu:function(){
          ...
          var startCalendar = new Date(xiaZhi.getYear() + '/' + xiaZhi.getMonth() + '/' + xiaZhi.getDay() + ' 0:0:0');
          ...
          var liQiuCalendar = new Date(liQiu.getYear() + '/' + liQiu.getMonth() + '/' + liQiu.getDay() + ' 0:0:0');
        ...
        getWuHou:function(){
          ...
          var startCalendar = new Date(startSolar.getYear() + '/' + startSolar.getMonth() + '/' + startSolar.getDay() + ' 0:0:0');
          var days = Math.floor((currentCalendar.getTime() - startCalendar.getTime()) / MS_PER_DAY);
    ...
    return {
      ...
      JIE_QI_IN_USE: ['DA_XUE', '冬至', '小寒', '大寒', '立春', '雨水', '惊蛰', '春分', '清明', '谷雨', '立夏', '小满', '芒种', '夏至', '小暑', '大暑', '立秋', '处暑', '白露', '秋分', '寒露', '霜降', '立冬', '小雪', '大雪', 'DONG_ZHI', 'XIAO_HAN', 'DA_HAN'],
      fromYmdHms:function(y,m,d,hour,minute,second){return _fromYmdHms(y,m,d,hour,minute,second);},
      fromYmd:function(y,m,d){return _fromYmdHms(y,m,d,0,0,0);},
      fromDate:function(date){return _fromDate(date);}
    };
  ...
  var HolidayUtil = (function(_NAMES){
    var _SIZE = 18,_ZERO='0'.charCodeAt(0),_NAMES_IN_USE=_NAMES,_DATA='';
